    ...
    render() {
        return (
            <div class="div-navbar">
                ...
                <button class="btn-navbar-cart">Cart ({this.state.productsInCart})<img class="img-cart" alt="cart" src="https://cdn0.iconfinder.com/data/icons/shopping-cart-26/1000/Shopping-Basket-02-512.png"/></button>
            </div>
        );
    }
}
